// 1.Create a Callable<Integer> that returns the sum of two numbers and execute it using ExecutorService
...
public class Question {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Callable<Long> factoriCallable = new Callable<Long>() {
            @Override
        ...
        Future<Long> future = exec.submit(factoriCallable);

        Long result = future.get();   // FIX: future.get()
